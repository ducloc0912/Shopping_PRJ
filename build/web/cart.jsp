            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html"><img src="images/logo.png" width="100rem;" class="logo" alt=""></a>
                    </div>
                                    ...
                                    <c:forEach var="cart" items="${sessionScope['cart'].items}">
                                        <tr>
                                            ...
                                            <td class="quantity-box">
                                                <a href="UpdateCart?productId=${cart.product.id}&action=add" class="btn btn-secondary">+</a>
                                                <span>${cart.quantity}</span>
                                                <a href="UpdateCart?productId=${cart.product.id}&action=subtract" class="btn btn-secondary">-</a>
                                            </td>
                                            <td class="total-pr">
