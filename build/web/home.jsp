            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="HomeController"><img src="images/logo.png" width="100rem;" class="logo" alt=""></a>
                    </div>
...
<!--                                    <li class="nav-item"><a class="nav-link" href="ManagerProduct">Manage Product</a></li>-->
                                    <li class="nav-item"><a class="nav-link" href="ManagerUser">Manage Staff</a></li>
                                    <li class="nav-item"><a class="nav-link" href="ManagerOrder">Dashboard</a></li>
                                    </c:if>
                                    <c:if test="${sessionScope['LOGIN_USER'].roleID=='STF'}">
                                    <li class="nav-item"><a class="nav-link" href="ManagerProduct">Manage Product</a></li>
                                    <li class="nav-item"><a class="nav-link" href="ManagerOrder">Dashboard</a></li>
                                    </c:if>
                                </c:if>
        ...
        <div id="slides-shop" class="cover-slides">
            <ul class="slides-container">
                <li class="text-center">
                    <img src="https://i.pinimg.com/564x/10/01/7c/10017c76e7a9880d236072934cebff29.jpg" alt="">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>Welcome To <br> ebay</strong></h1>
                ...
                <li class="text-center">
                    <img src="https://i.pinimg.com/736x/b0/3c/e5/b03ce5b35db3b7db0b451acde90ab40a.jpg" alt="">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>Welcome To <br> ebay</strong></h1>
